...
class Lumitexel_Dataset(Dataset):
    def __init__(self, img_path, split, transform):
        ...
        self.lumitexel_list = np.load(img_path)
    ...
    def __getitem__(self, index):
        ...
        # lumitexel_A =
        lumitexel = self.lumitexel_list[index]
        label = self.lumitexel_list[index]
        ...
        if self.transform is not None:
            lumitexel = self.transform(lumitexel)
